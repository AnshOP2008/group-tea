...
function Index() {
  ...
  useEffect(() => {
    ...
    try {
      const did =
        (typeof window !== "undefined" &&
          localStorage.getItem("gt_device_id")) ||
        null;
    ...
    // Verify the local choice still exists server-side
    (async () => {
      try {
        const did =
          typeof window !== "undefined"
    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-3xl mx-auto px-4 pt-10 pb-20">
        <section className="text-center animate-fade-up">
          <div className="inline-block animate-float text-6xl mb-4">
            🍵
          </div>
          ...
          <p className="mt-3 text-muted-foreground max-w-lg mx-auto">
            Get to know your group one last time — vote on three questions and
            drop one anonymous tea. See where your batch stands when results
            unlock.
          </p>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
            ...
            */}
            ...
            <Link
              to="/results"
              className="px-6 py-3 rounded-full bg-white/70 border border-border font-semibold hover:bg-white transition"
            >
              Peek at results
            </Link>
          </div>
        ...
        <section className="mt-10 glass-card p-6 animate-fade-up">
          ...
          <ol className="mt-3 space-y-2 text-sm text-muted-foreground list-decimal list-inside">
            ...
            <li>
              Answer 3 quick questions — change your mind any time before
              unlock.
            </li>

            <li>
              Drop one anonymous tea (max 150 chars). No take-backs.
            </li>

            <li>
              Wait for the timer, then watch the rankings drop. ✨
            </li>
          </ol>
        </section>
      </main>
